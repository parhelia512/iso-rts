...
const std::unordered_map<GameObjectTypeId, std::string> ObjectData::TITLES =
    {
        ...
        { ObjectData::TYPE_DEFENSIVE_TOWER, "DEFENSIVE_TOWER"},
        ...
        { ObjectData::TYPE_RES_GEN_ENERGY, "ENERGY_GENERATOR"},
        { ObjectData::TYPE_RES_GEN_ENERGY_SOLAR, "SOLAR_PANELS"},
        { ObjectData::TYPE_RES_GEN_MATERIAL, "MATERIAL_GENERATOR"},
        { ObjectData::TYPE_RES_GEN_MATERIAL_EXTRACT, "MATERIAL_EXTRACTOR"},
        { ObjectData::TYPE_RES_STORAGE_BLOBS, "BLOBS_STORAGE"},
        { ObjectData::TYPE_RES_STORAGE_DIAMONDS, "DIAMONDS_STORAGE"},
        { ObjectData::TYPE_RES_STORAGE_ENERGY, "ENERGY_STORAGE"},
        { ObjectData::TYPE_RES_STORAGE_MATERIAL, "MATERIAL_STORAGE"},
        { ObjectData::TYPE_ROCKS, "ROCKS"},
        { ObjectData::TYPE_SPAWN_TOWER, "SPAWNING_TOWER"},
