...
void ObjectsDataRegistry::InitWeaponData()
{
    mDataWeapons.emplace(WeaponData::TYPE_LASER1,
        WeaponData(WeaponData::TYPE_LASER1, WEAPONC_LASER, 2, 0.5f,
