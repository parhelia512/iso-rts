...
{
    mDataObjects.emplace(GameObject::TYPE_BARRACKS,
    ...
    mDataObjects.emplace(GameObject::TYPE_BASE,
        ObjectData({ {OBJ_ATT_ENERGY, 6}, {OBJ_ATT_VIEW_RANGE, 6}, {OBJ_ATT_REGENERATION, 5},
                   ...
                   { ID_STRUCT_BASE_L1_F1, ID_STRUCT_BASE_L1_F2, ID_STRUCT_BASE_L1_F3,
                     ID_STRUCT_BASE_L1}, SpriteFileStructures, GameObject::TYPE_BASE,
                   GameObject::CAT_STRUCTURE, OCS_BASE, OCAT_GENERIC, WeaponData::TYPE_NULL, 3, 3));

    mDataObjects.emplace(GameObject::TYPE_BASE_SPOT,
    ...
    mDataObjects.emplace(GameObject::TYPE_BLOBS,
    ...
    mDataObjects.emplace(GameObject::TYPE_BUNKER,
        ObjectData({ {OBJ_ATT_ENERGY, 4}, {OBJ_ATT_VIEW_RANGE, 3}, {OBJ_ATT_REGENERATION, 4},
                   ...
                   SpriteFileStructures, GameObject::TYPE_BUNKER, GameObject::CAT_STRUCTURE,
                   OCS_TOWER, OCAT_DEFENSE, WeaponData::TYPE_LASER4, 1, 1));

    mDataObjects.emplace(GameObject::TYPE_DEFENSIVE_TOWER,
    ...
    mDataObjects.emplace(GameObject::TYPE_DIAMONDS,
    ...
    mDataObjects.emplace(GameObject::TYPE_HOSPITAL,
        ObjectData({ {OBJ_ATT_ENERGY, 5}, {OBJ_ATT_VIEW_RANGE, 4}, {OBJ_ATT_REGENERATION, 5},
    ...
    mDataObjects.emplace(GameObject::TYPE_LOOTBOX,
    ...
    mDataObjects.emplace(GameObject::TYPE_MINI_UNIT1,
    ...
    mDataObjects.emplace(GameObject::TYPE_MINI_UNIT2,
    ...
    mDataObjects.emplace(GameObject::TYPE_MOUNTAINS,
        ObjectData({ {OBJ_ATT_ENERGY, 1}, {OBJ_ATT_HEALTH, 9}, {OBJ_ATT_RESISTANCE, 7} }, {},
                   ...
                   GameObject::CAT_SCENE_OBJ, OCO_SCENE, OCAT_UNDEFINED, WeaponData::TYPE_NULL, 2, 2));

    mDataObjects.emplace(GameObject::TYPE_PRACTICE_TARGET,
    ...
    mDataObjects.emplace(GameObject::TYPE_RADAR_STATION,
    ...
    mDataObjects.emplace(GameObject::TYPE_RADAR_TOWER,
    ...
    mDataObjects.emplace(GameObject::TYPE_RESEARCH_CENTER,
    ...
    mDataObjects.emplace(GameObject::TYPE_RES_GEN_ENERGY,
    ...
    mDataObjects.emplace(GameObject::TYPE_RES_GEN_ENERGY_SOLAR,
    ...
    mDataObjects.emplace(GameObject::TYPE_RES_GEN_MATERIAL,
        ObjectData({ {OBJ_ATT_ENERGY, 9}, {OBJ_ATT_VIEW_RANGE, 4}, {OBJ_ATT_REGENERATION, 3},
                     {OBJ_ATT_RESISTANCE, 2}, {OBJ_ATT_SHIELD, 1}, {OBJ_ATT_HEALTH, 5} },
                   { 0, 0, 0, 0 },
    ...
    mDataObjects.emplace(GameObject::TYPE_RES_GEN_MATERIAL_EXTRACT,
        ObjectData({ {OBJ_ATT_ENERGY, 4}, {OBJ_ATT_VIEW_RANGE, 2}, {OBJ_ATT_REGENERATION, 2},
                     {OBJ_ATT_RESISTANCE, 2}, {OBJ_ATT_SHIELD, 2}, {OBJ_ATT_HEALTH, 4} },
                   { 250, 250, 10, 10 },
    ...
    mDataObjects.emplace(GameObject::TYPE_RES_STORAGE_BLOBS,
    ...
    mDataObjects.emplace(GameObject::TYPE_RES_STORAGE_DIAMONDS,
        ObjectData({ {OBJ_ATT_ENERGY, 3}, {OBJ_ATT_VIEW_RANGE, 2}, {OBJ_ATT_REGENERATION, 2},
                     {OBJ_ATT_RESISTANCE, 3}, {OBJ_ATT_SHIELD, 4}, {OBJ_ATT_STORAGE, 3},
                     {OBJ_ATT_HEALTH, 4} },
                   { 100, 100, 0, 0 },
    ...
    mDataObjects.emplace(GameObject::TYPE_RES_STORAGE_ENERGY,
        ObjectData({ {OBJ_ATT_ENERGY, 3}, {OBJ_ATT_VIEW_RANGE, 2}, {OBJ_ATT_REGENERATION, 2},
    ...
    mDataObjects.emplace(GameObject::TYPE_RES_STORAGE_MATERIAL,
        ObjectData({ {OBJ_ATT_ENERGY, 3}, {OBJ_ATT_VIEW_RANGE, 2}, {OBJ_ATT_REGENERATION, 2},
    ...
    mDataObjects.emplace(GameObject::TYPE_ROCKS,
    ...
    mDataObjects.emplace(GameObject::TYPE_SPAWN_TOWER,
    ...
    mDataObjects.emplace(GameObject::TYPE_TEMPLE,
    ...
    mDataObjects.emplace(GameObject::TYPE_TRADING_POST,
        ObjectData({ {OBJ_ATT_ENERGY, 5}, {OBJ_ATT_VIEW_RANGE, 4}, {OBJ_ATT_REGENERATION, 4},
    ...
    mDataObjects.emplace(GameObject::TYPE_TREES,
    ...
    mDataObjects.emplace(GameObject::TYPE_UNIT_MEDIC1,
    ...
    mDataObjects.emplace(GameObject::TYPE_UNIT_SCOUT1,
        ObjectData({ {OBJ_ATT_ENERGY, 5}, {OBJ_ATT_VIEW_RANGE, 4}, {OBJ_ATT_REGENERATION, 4},
    ...
    mDataObjects.emplace(GameObject::TYPE_UNIT_SOLDIER1,
    ...
    mDataObjects.emplace(GameObject::TYPE_UNIT_SOLDIER2,
        ObjectData({ {OBJ_ATT_ENERGY, 4}, {OBJ_ATT_VIEW_RANGE, 5}, {OBJ_ATT_REGENERATION, 4},
                   ...
                   GameObject::TYPE_UNIT_SOLDIER2, GameObject::CAT_UNIT, OCU_SOLDIER, OCAT_UNIT,
                   WeaponData::TYPE_LASER3, 1, 1));

    mDataObjects.emplace(GameObject::TYPE_UNIT_SPAWNER1,
    ...
    mDataObjects.emplace(GameObject::TYPE_UNIT_SPAWNER2,
        ObjectData({ {OBJ_ATT_ENERGY, 6}, {OBJ_ATT_VIEW_RANGE, 6}, {OBJ_ATT_REGENERATION, 5},
    ...
    mDataObjects.emplace(GameObject::TYPE_UNIT_WORKER1,
    ...
    mDataObjects.emplace(GameObject::TYPE_WALL,
        ObjectData({ {OBJ_ATT_ENERGY, 1}, {OBJ_ATT_VIEW_RANGE, 2}, {OBJ_ATT_REGENERATION, 5},
    ...
    mDataObjects.emplace(GameObject::TYPE_WALL_GATE,
