...
const std::string GameObject::TYPE_STR_MINI_UNIT2("MINIUNIT2");
...
const std::string GameObject::TYPE_STR_UNIT_SPAWNER2("UNIT_SPAWNER2");
...
const GameObjectTypeId GameObject::TYPE_MINI_UNIT2 = h{}(TYPE_STR_MINI_UNIT2);
...
const GameObjectTypeId GameObject::TYPE_UNIT_SPAWNER2 = h{}(TYPE_STR_UNIT_SPAWNER2);
...
const std::unordered_map<GameObjectTypeId, std::string> GameObject::TYPE_STR_MAP =
{
    ...
    { GameObject::TYPE_MINI_UNIT2, TYPE_STR_MINI_UNIT2 },
    ...
    { GameObject::TYPE_UNIT_SPAWNER2, TYPE_STR_UNIT_SPAWNER2 },
...
const std::unordered_map<GameObjectTypeId, std::string> GameObject::TITLES =
{
    ...
    { GameObject::TYPE_MINI_UNIT2, "MINI UNIT 2"},
    ...
    { GameObject::TYPE_UNIT_SPAWNER1, "MINI SPAWNER"},
    { GameObject::TYPE_UNIT_SPAWNER2, "SPAWNER"},
...
const std::unordered_map<GameObjectTypeId, std::string> GameObject::DESCRIPTIONS =
{
    ...
    { GameObject::TYPE_MINI_UNIT2, "Mini units that shoot enemies close to their target position."},
